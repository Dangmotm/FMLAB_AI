...
if args.function == 'pretrain':
    ...
    if args.reading_params_path is not None and args.reading_params_path != '':
        # Part f: WITH pretrained model
        print(f"Loading pretrained model from {args.reading_params_path}")
        model.load_state_dict(torch.load(args.reading_params_path))
        max_epochs = 10
    else:
        # Part c: WITHOUT pretrained model (train from scratch)
